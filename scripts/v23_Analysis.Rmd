...
#---------Load in data--------
```{r}
data <- read.csv("../data/rating-task/v23/data_exp_169297-v23_task-6dig.csv")
...
## 10-9-24 correlation between emotions
```{r}
...
music_negative_summary <- plot_emotion_means(music_negative, "Music Negative Emotion Means", "../results/rating-task/Music_Negative_Means_10_7_24.png", "Music")
music_positive_summary <- plot_emotion_means(music_positive, "Music Positive Emotion Means", "../results/rating-task/Music_Positive_Means_10_7_24.png", "Music")
pic_negative_summary <- plot_emotion_means(pic_negative, "Picture Negative Emotion Means", "../results/rating-task/Picture_Negative_Means_10_7_24.png", "Picture")
pic_positive_summary <- plot_emotion_means(pic_positive, "Picture Positive Emotion Means", "../results/rating-task/Picture_Positive_Means_10_7_24.png", "Picture")
...
ggsave('../results/rating-task/Negative_Emotion_Means_10_7_24.png', neg_plot, width = 9)
ggsave('../results/rating-task/Positive_Emotion_Means_10_7_24.png', pos_plot, width = 9)
```
...
png("../results/rating-task/Emotion Response Percentages_10_7_24.png", width = 400, height = 400)
...
# Save the plot
ggsave('../results/rating-task/All_Emotion_Means_10_7_24.png', full_plot, width = 9)
```
...
# Save the plots
ggsave('../results/rating-task/Emotion_Category_Means_10_7_24.png', summary_plot, width = 9)
...
# Save the plot
ggsave('../results/rating-task/All_Stims_Means_10_7_24.png', all_stims_plotted, width = 14)
...
ggsave('../results/rating-task/Average_Stims_Means_10_7_24.png', collapsed_plot, width = 10)
```
...
create_histogram(results_recode, c("negmusicICC", "negpicICC"), 
                 ...
                 "../results/rating-task/Negative_ICCs_Recoded_10_7_24.png")
...
create_scatter_plot(results, "negpicICC", "negmusicICC", 
                    ...
                    "../results/rating-task/Neg_Graph_10_7_24.png")
...
create_scatter_plot(results, "pospicICC", "posmusicICC", 
                    ...
                    "../results/rating-task/Pos_Graph_10_7_24.png")
...
create_scatter_plot(results, "allpicICC", "allmusicICC", 
                    ...
                    "../results/rating-task/Combined_Graph_10_7_24.png")
...
create_scatter_plot(results_recode, "negpicICC", "negmusicICC", 
                    ...
                    "../results/rating-task/Neg_Graph_Recoded_10_7_24.png")
...
create_scatter_plot(results_recode, "pospicICC", "posmusicICC", 
                    ...
                    "../results/rating-task/Pos_Graph_Recoded_10_7_24.png")
...
create_scatter_plot(results_recode, "allpicICC", "allmusicICC", 
                    ...
                    "../results/rating-task/Combined_Graph_Recoded_10_7_24.png")
```
...
create_mean_comparison_plot(results, 
                            ...
                            '../results/rating-task/Mean_Comparisons_10_7_24.png')
...
create_mean_comparison_plot(results_recode, 
                            ...
                            '../results/rating-task/Mean_Comparisons_Recoded_10_7_24.png')
```
