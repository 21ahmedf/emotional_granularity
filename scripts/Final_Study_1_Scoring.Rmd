...
# Select only the numeric columns for the correlation matrix
numeric_columns_recoded <- merged_df_recoded[, sapply(merged_df_recoded, is.numeric)] %>%
  select("STAI_total", "CD.RISC_total","Gold_musicaltraining", "BDI_total", "rdees_range", "rdees_differentiation", "rdees_total", "negmusicICC":"pospicICC")
...
# Combine the folder path with the file name
output_file <- file.path(output_folder, "corrplotstudy1_postertest.pdf")

# Open a PNG device with the specified file path
pdf(output_file, width=10)
colnames(correlation_matrix_recoded) <- c('STAI Trait Score', 'CD.RISC Score', 'Gold-MSI: Musical Training', 'BDI Score', 'RDEES: Range Score', 'RDEES: Differentiation Score', 'Total RDEES Score',  "Negative Emotional Granularity Score: Music", "Positive Emotional Granularity Score: Music", 
                           "Negative Emotional Granularity Score: Pictures","Positive Emotional Granularity Score: Pictures")
rownames(correlation_matrix_recoded) <- c('STAI Trait Score', 'CD.RISC Score', 'Gold-MSI: Musical Training', 'BDI Score', 'RDEES: Range Score', 'RDEES: Differentiation Score', 'Total RDEES Score',  "Negative Emotional Granularity Score: Music", "Positive Emotional Granularity Score: Music", 
                           "Negative Emotional Granularity Score: Pictures","Positive Emotional Granularity Score: Pictures")
