...
OASIS_selected <-
  ggplot(data=OASIS_clean, aes(x=Valence_mean, y=Arousal_mean, label=Theme))+
  ...
  #geom_text() +
  xlab('Normed Valence Rating') + ylab('Normed Arousal Rating') +
  theme_classic() +
  geom_point(data=selected_OASIS_final, aes(color="red"))+
...
ggsave('OASIS_selected.png',OASIS_selected, dpi=1000, width=9)
