...
### EXCLUDE PARTICIPANTS FROM STUDY 1 - No longer doing that (8/13/26)
```{r}
...
#write dfs
```{r}
write.csv(file = '../data/study1final_negativeratings.csv',negative_ratings)
write.csv(file = '../data/study1final_positiveratings.csv',positive_ratings)

write.csv(file = '../data/study1final_granularityscores.csv',results_recode)
```