...
install.packages(c("Matrix", "lme4"), type = "binary")
```
...
m1 <- lmer(data=master_ratingsperemotion, (value) ~ condition*rating_valence*stimulus_valence + (condition:stimulus_valence:rating_valence + condition*rating_valence|Participant.Public.ID),control=lmerControl(optimizer="bobyqa")) #removed stim intercept to assist in model convergence and main random effect of stimulus_valence (explained least amt of variance)
anova(m1)
