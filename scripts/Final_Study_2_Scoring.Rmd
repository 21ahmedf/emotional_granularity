...
hist(final_scores_study2$rdees_differentiation)
```
...
output_file <- file.path(output_folder, "Significant Correlations Plot Study 2 - RDEES Outliers Kept 3-22-25.png")
...
title(main = "Significant Correlations Study 2 - RDEES Outliers Kept", col.main = "black", font.main = 4)
...
```{r}
boxplot.stats(merged_df_study2_recoded$rdees_range)$out
boxplot.stats(merged_df_study2_recoded$rdees_differentiation)$out
boxplot.stats(merged_df_study2_recoded$rdees_total)$out

merged_df_study2_recoded$rdees_range[merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_069" | merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_074" | merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_098"] <- NA

merged_df_study2_recoded$rdees_differentiation[merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_069" | merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_074" | merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_098"] <- NA

merged_df_study2_recoded$rdees_total[merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_069" | merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_074" | merged_df_study2_recoded$SURVEY_CODE == "TEAM_YA_098"] <- NA
