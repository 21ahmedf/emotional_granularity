...
```{r}
#v8 data
v8 <- read.csv("../data/rating-task/data_exp_169297-v8/data_exp_169297-v8_task-6dig.csv")
v8 <- v8 %>% mutate(Spreadsheet..relaxed_rating = NA)

#v9 data
v9 <- read.csv("../data/rating-task/data_exp_169297-v9/data_exp_169297-v9_task-6dig.csv")
v9 <- v9 %>% mutate(Spreadsheet..relaxed_rating = NA)

#v10 data
v10 <- read.csv("../data/rating-task/data_exp_169297-v10/data_exp_169297-v10_task-6dig.csv")

#combined data
combined_data <- rbind(v8, v9, v10)
...
# Append 60 rows to the 2nd (satisfied) dataframe
# Prepend 40 rows to the 6th (relaxed) dataframe
filtered_music_pos[[2]] <- extend_df(filtered_music_pos[[2]], 40)
filtered_music_pos[[6]] <- prepend_rows(filtered_music_pos[[6]], 60)

filtered_pic_pos[[2]] <- extend_df(filtered_pic_pos[[2]], 40)
filtered_pic_pos[[6]] <- prepend_rows(filtered_pic_pos[[6]], 60)
...
ggsave('../results/rating-task/Music_Negative_Means.png', music_negative_means, width = 9)
...
ggsave('../results/rating-task/Music_Positive_Means.png', music_positive_means, width = 9)
...
ggsave('../results/rating-task/Picture_Positive_Means.png', pic_positive_means, width = 9)
...
ggsave('../results/rating-task/Picture_Negative_Means.png', pic_negative_means, width = 9)
```
...
# Save the plots
ggsave('../results/rating-task/Negative_Emotion_Means.png', neg_plot, width = 9)
ggsave('../results/rating-task/Positive_Emotion_Means.png', pos_plot, width = 9)
...
png("../results/rating-task/emotion_response_percentages.png", width = 400, height = 400)
